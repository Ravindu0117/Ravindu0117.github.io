                    ...
                    <!-- Left Column: Text -->
                        <div class="col-lg-4 text-start">
                            <div class="hero__text">
                                <span>For software solutions</span>
                                <h2>Software Developer’s Portfolio</h2>
                                <a href="{{ route('about') }}" class="primary-btn">See more about me</a>
                            </div>
                        </div>
                    <!-- Right Column: Floating Image -->
                        <div class="col-lg-8 text-center position-relative">
                            <div class="position-absolute top-50 start-50 translate-middle">
                                <img src="img/dd.jpeg" alt="Profile" class="profile-img rounded-circle border border-4 border-white shadow">
                            </div>
                        </div>
                    </div>
                 </div>
           ...
           <div class="hero__item set-bg" data-setbg="img/hero/hero-3.jpg">
                <div class="container">
                    ...
                    <!-- Left Column: Text -->
                        <div class="col-lg-4 text-start">
                            <div class="hero__text">
                                <span>For website developing</span>
                                <h2>Full Stack Developer’s Portfolio</h2>
            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="services__title">
                        ...
                        <p>If you hire me for your task you will get a professional view for your Software/ Website/ Web application
                        ,once the project is over.</p>
                        <a href="{{ route('portfolio') }}" class="primary-btn">View My Projects</a>
                        <br><br><br>
